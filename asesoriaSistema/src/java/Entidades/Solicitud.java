...
public class Solicitud {
    ...
    public Solicitud(String institucion, String email, String telefono) {
    ...
    public Solicitud(String fechaa) {
        this.fechaa = fechaa;
    }
    ...
    public Solicitud(int id, String tema, String descripcion, int id_asesor, int id_solicitante, int id_administrador, Date fecha, Time hora, String estatus, String nombre_solicitante, String nombre_asesor) {
        this.id = id;
        this.tema = tema;
